...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
            ...
            <p class="lead">Zaktualizuj produkt</p>
        </div>
       ...
       <form:hidden path="productId" value="${product.productId}"/>
        ...
        <div class="form-group">
            ...
            <form:input path="productPrice" id="price" class="form-Control" name="${product.productPrice}"/>
        </div>
        ...
        <div class="form-group">
            ...
            <form:input path="unitInStock" id="unitInStock" class="form-Control" name="${product.unitInStock}"/>
        </div>

        <div class="form-group">
            <label for="manufacturer">Manufacturer</label>
            <form:input path="productManufacturer" id="manufacturer" class="form-Control" name="${product.productManufacturer}"/>
        </div>
